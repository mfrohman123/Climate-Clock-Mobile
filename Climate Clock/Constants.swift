...
let appTitle = "Climate Clock Mobile"
let webAppUrl = URL(string: "https://climateclock.world/mobile/index.html#/")
let allowedOrigin = "climateclock.world"
...
let navigationBarColor = getColorFromHex(hex: 0xFFFFFF, alpha: 1.0) //0xF44336
